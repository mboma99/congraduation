        ...
        <React.Fragment>
            <nav>
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto pt-10 p-4">
                    <a href='/' className='tracking-[.3em] uppercase text-2xl font-semibold text-white text-center cursor-pointer'>congraduation</a>
                    ...
                    <div className="hidden w-full md:block md:w-auto" id="navbar-default">
                        <ul className="flex text-base tracking-[.3em] uppercase flex-col mt-4 md:flex-row md:space-x-10 md:mt-0">
                            ...
                            <li>
                                <a href="/about" className="hover:text-gray-800 text-white">About</a>
                            </li>
                            <li><a href='/account'>
